  ...
  return (
    <div className="container-xxl flex-grow-1 container-p-y">
      <div className="card-header d-flex justify-content-between align-items-center py-2">
        <h5>
          <span className="text-muted fw-light">Sales /</span> Sales Agreement
        </h5>
        <div className="mb-2 text-end">
          <Link
            to="/sales/addSalesAgreement"
            className="ms-2 btn  btn-primary btn-sm waves-effect waves-light"
          >
            <span className="mdi mdi-plus"></span> Sales Agreement
          </Link>
        </div>
      </div>
      <div className="card">
        <div className="card-header d-flex justify-content-between align-items-center bg-label-primary py-2">
          <h5 className="mb-0">Agreement :</h5>
                    ...
                    <thead className="table-secondary">
                      <tr>
                        ...
                        <td
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="Agreement ID: activate to sort column ascending"
                          style={{ width: "147.2px" }}
                        >
                          Agreement ID
                        </td>
                        ...
                        <td
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="Upload by: activate to sort column ascending"
                          style={{ width: "113.2px" }}
                        >
                          Upload by
                        </td>
                        <td
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="Upload file: activate to sort column ascending"
                          style={{ width: "128.2px" }}
                        >
                          Upload file
                        </td>
