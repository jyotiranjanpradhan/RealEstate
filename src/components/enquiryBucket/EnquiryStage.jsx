function EnquiryStage() {
  return (
    <div class="container-xxl flex-grow-1 container-p-y">
      <h5 class="mb-1">
        <span class="text-muted fw-light">Enquiry Bucket /</span> Lead Enquiry
        Stage
      </h5>
                  ...
                  <div class="modal-dialog">
                    <form class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title" id="">Add  Lead Enquiry Stage</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                        <div class="row">
                          <div class="col-md-12 mt-2 mb-2">
                            <label for="defaultInput" class="form-label">Lead Stage Name</label>
                            <input id="" class="form-control" type="text" placeholder="Lead Stage Name" autocomplete="off">
                          </div>
