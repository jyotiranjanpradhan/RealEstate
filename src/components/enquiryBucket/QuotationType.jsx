function QuotationType() {
  return (
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      {/* <!-- Modal -->
                <div class="modal fade animate__animated animate__bounceInDown" id="modalTop" tabindex="-1" aria-hidden="true" style="display: none;">
                  <div class="modal-dialog">
                    <form class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title" id="">Add Quotation Type</h4>
