...
import { apiAddTAX } from '../../services/Project/apiAddTax';
...
function onSubmit(data) {
  ...
  formData.append("tax_amount", data.value);
  ...
  return (
    <>
      ...
      <div className="card-header d-flex justify-content-between align-items-center py-2">
        <h5>
          <span className="text-muted fw-light">Project /</span> Add Tax & Others
        </h5>
